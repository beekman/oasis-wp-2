			...
			<div id="content">
				...
				<div id="inner-content" class="wrap cf">
					...
					<div id="main" class="m-all t-2of3 d-5of7 cf" role="main">
						<h1 class="archive-title"><span><?php _e( 'Search Results for:', 'oasistheme' ); ?></span> <?php echo esc_attr(get_search_query()); ?></h1>
						...
						<?php endwhile; ?>
							...
							<?php else : ?>
									...
									<article id="post-not-found" class="hentry cf">
										<header class="article-header">
											<h1><?php _e( 'Sorry, No Results.', 'oasistheme' ); ?></h1>
										</header>
										<section class="entry-content">
											<p><?php _e( 'Try your search again.', 'oasistheme' ); ?></p>
										</section>
										<footer class="article-footer">
												<p><?php _e( 'This is the error message in the search.php template.', 'oasistheme' ); ?></p>
										</footer>
									</article>
