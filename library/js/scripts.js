...
jQuery(function() { /*<- shortcut for document ready*/
  ...
  // jQuery(".gquote").fadeIn(5000); // Ghibran quote on home page fades in.
  // jQuery("#menu-blog-nav").fadeIn(5000); // Blog nav menu fades in.
      // jQuery("#poptext").hide();
  // jQuery("#signup-box").hoverIntent(poptext);
  jQuery(".accordion").accordion({ /* accordion for faq and whatsnew */
    /* icons: true, */
    event: "click",
    disabled: false,
    collapsible: true,
