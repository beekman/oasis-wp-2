...
while (have_posts()) {
                  ...
                  ?></p>
						...
						<footer class="article-header">
							<p class="tags"><?php echo get_the_term_list( get_the_ID(), 'custom_tag', '<span class="tags-title">' . __('Custom Tags:', 'oasistheme') . '</span> ', ', ' ) ?></p>
					...
					<?php else { ?>
        					...
        					<article id="post-not-found" class="hentry clearfix">
        						...
        						<p><?php _e("This is the error message in the single-custom_type.php template.", "oasistheme"); ?></p>
        						</footer>
        					</article>
